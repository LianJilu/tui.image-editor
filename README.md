# Toast UI ImageEditor With Eraser
...
- [!Toast UI ImageEditor With Eraser](#)
  ...
  - [💾 Install](#-install)
    - [Via Package Manager](#via-package-manager)
      - [npm](#npm)
      - [1. ImageEditor installation](#1-imageeditor-installation)
        - [2. If the installation of the `fabric.js` dependency module does not go smoothly](#2-if-the-installation-of-the-fabricjs-dependency-module-does-not-go-smoothly)
      - [bower](#bower)
  ...
  - [🔨 Usage](#-usage)
    ...
    - [Menu svg icon setting](#menu-svg-icon-setting)
      - [There are two ways to set icons.](#there-are-two-ways-to-set-icons)
